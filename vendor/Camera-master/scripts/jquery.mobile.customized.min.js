  ...
  (function (a, b, d) {
      ...
      (g = (function () {
        function n() {
          var c = k(),
            d = m(h);
          c !== h
            ? (l((h = c), d), a(b).trigger(e))
            : d !== h && (location.href = location.href.replace(/#.*/, "") + d),
            (g = setTimeout(n, a.fn[e].delay));
        }
        var c = {},
          g,
          h = k(),
              ...
              (c.start = function () {
                ...
                (l = function (c, d) {
                  ...
                  c !== d &&
                    ...
                    g.open(),
                    h &&
                      g.write('<script>document.domain="' + h + '"</script>'),
                    g.close(),
                    (b.location.hash = c));
                });
            })(),
      ...
      var b = 250,
        c = function () {
          (f = new Date().getTime()),
            (g = f - d),
            g >= b
              ? ((d = f), a(this).trigger("throttledresize"))
              : (e && clearTimeout(e), (e = setTimeout(c, b - g)));
        },
        d = 0,
        e,
        f,
    ...
    (function (a, b) {
      (a.fn.fieldcontain = function (a) {
        ...
        a(c).bind("pagecreate create", function (b) {
          a(":jqmData(role='fieldcontain')", b.target)
            .jqmEnhanceable()
            .fieldcontain();
        });
    })(a),
    (function (a, b) {
      a.fn.grid = function (b) {
        return this.each(function () {
          ...
          (h = f[g]),
            c.addClass("ui-grid-" + g),
            e.filter(":nth-child(" + h + "n+1)").addClass("ui-block-a"),
            h > 1 &&
              e.filter(":nth-child(" + h + "n+2)").addClass("ui-block-b"),
            h > 2 &&
              e.filter(":nth-child(" + h + "n+3)").addClass("ui-block-c"),
            h > 3 &&
              e.filter(":nth-child(" + h + "n+4)").addClass("ui-block-d"),
            h > 4 &&
              e.filter(":nth-child(" + h + "n+5)").addClass("ui-block-e");
        });
      };
    })(a),
    (function (a) {
      ...
      (a.mobile = a.extend(
        a.mobile,
        {
          ...
          silentScroll: function (c) {
            a.type(c) !== "number" && (c = a.mobile.defaultHomeScroll),
          ...
          haveParents: function (b, c) {
            ...
            for (var i = 0; i < d; i++) {
              (g = b.eq(i)), (h = !1), (f = b[i]);
              while (f) {
                var j = f.getAttribute
                  ? f.getAttribute("data-" + a.mobile.ns + c)
                  : "";
                if (j === "false") {
                  h = !0;
                  break;
    ...
    (function (a, b) {
      ...
      (a.event.special.orientationchange = a.extend(
        ...
        (a.event.special.orientationchange.orientation = g =
          function () {
            var d = !0,
              e = c.documentElement;
            return (
              a.support.orientation
                ? (d = k[b.orientation])
                : (d = e && e.clientWidth / e.clientHeight < 1.1),
    ...
    (function (a, d) {
      ...
      function m(a, b, d) {
        var e = c.createElement("div"),
          ...
          g = function (a) {
            return a === ""
              ? ""
              : "-" + a.charAt(0).toLowerCase() + a.substr(1) + "-";
          },
          i = function (c) {
            var d = g(c) + a + ": " + b + ";",
              h = f(c),
      ...
      function n() {
        ...
        var i = c.createElement("div"),
          j = { MozTransform: "-moz-transform", transform: "transform" };
        f.append(i);
        for (var k in j)
          i.style[k] !== d &&
            ((i.style[k] = "translate3d( 100px, 1px, 1px )"),
            (g = b.getComputedStyle(i).getPropertyValue(j[k])));
        return !!g && g !== "none";
      }
      function o() {
        var b =
        ...
        return (
          c.length
            ? (e = c.attr("href"))
            : (c = d = a("<base>", { href: b }).appendTo("head")),
          (g = a("<a href='testurl' />").prependTo(f)),
          (h = g[0].href),
      ...
      function r() {
        ...
        return ((d.indexOf("iPhone") > -1 ||
          ...
          f < 534) ||
          (a.operamini &&
            {}.toString.call(a.operamini) === "[object OperaMini]") ||
          (i && j < 7458) ||
          (c.indexOf("Android") > -1 && f && f < 533) ||
          (h && h < 6) ||
          ("palmGetResource" in b && f && f < 534) ||
      ...
      var f = a("<body>").prependTo("html"),
        ...
        j = b.opera,
        k =
          b.operamini && {}.toString.call(b.operamini) === "[object OperaMini]",
      ...
      a.extend(a.mobile, { browser: {} }),
        ...
        a.extend(a.support, {
          cssTransitions:
            ...
            (m("transition", "height 100ms linear", ["Webkit", "Moz", ""]) &&
              !a.mobile.browser.oldIE &&
              !j),
          pushState:
            "pushState" in history &&
            "replaceState" in history &&
            b.navigator.userAgent.search(/CriOS/) === -1,
      ...
      (a.mobile.gradeA = function () {
        return (
          (a.support.mediaquery ||
            (a.mobile.browser.oldIE && a.mobile.browser.oldIE >= 7)) &&
          (a.support.boundingRect ||
            a.fn.jquery.match(/1\.[0-7+]\.[0-9+]?/) !== null)
        );
      }),
        (a.mobile.ajaxBlacklist = (b.blackberry && !b.WebKitPoint) || k || s),
        s &&
          a(function () {
    ...
    (function (a, b) {
      ...
      a.event.special.navigate = d = {
        ...
        hashchange: function (b, d) {
          ...
          (e.originalEvent = b),
            c.trigger(e, { state: b.hashchangeState || {} });
        },
        setup: function (a, b) {
          if (d.bound) return;
          (d.bound = !0),
            d.isPushStateEnabled()
              ? ((d.originalEventName = "popstate"),
                c.bind("popstate.navigate", d.popstate))
              : d.isHashChangeEnabled() &&
                ((d.originalEventName = "hashchange"),
                c.bind("hashchange.navigate", d.hashchange));
        },
      };
    })(a),
    (function (a, b, c) {
            ...
            function (c, e, f, g) {
              var h = new a.Deferred(),
                ...
                n =
                  ...
                  !c ||
                  c === "none" ||
                  Math.max(a.mobile.window.scrollTop(), k) >
                    a.mobile.getMaxScrollForTransition(),
                o = " ui-page-pre-in",
                p = function () {
                  a.mobile.pageContainer.toggleClass(
                    "ui-mobile-viewport-transitioning viewport-" + c
                  );
                },
                q = function () {
                  (a.event.special.scrollstart.enabled = !1),
                ...
                r = function () {
                  g.removeClass(
                    a.mobile.activePageClass + " out in reverse " + c
                  ).height("");
                },
                s = function () {
                  d ? g.animationComplete(t) : t(),
                    g
                      .height(l + a.mobile.window.scrollTop())
                      .addClass(c + " out" + i);
                },
                t = function () {
                  g && d && r(), u();
      ...
      (a.mobile.defaultTransitionHandler = e),
        ...
        (a.mobile.getMaxScrollForTransition =
          a.mobile.getMaxScrollForTransition || g);
    })(a, this),
    (function (a, b, c, d) {
      function x(a) {
            ...
            c.bind(h, function (b) {
              function g(b) {
                ...
                (f = a.event.special.swipe.stop(b)),
                  Math.abs(e.coords[0] - f.coords[0]) >
    ...
    (function (a, b) {
      ...
      (a.fn.buttonMarkup = function (e) {
        ...
        for (var j = 0; j < f.length; j++) {
            ...
            m = a.extend(
              ...
              a.fn.buttonMarkup.defaults,
              {
                ...
                theme:
                  e.theme !== b
                    ? e.theme
                    : d(l, h + "theme") || a.mobile.getInheritedTheme(k, "c"),
                ...
                iconshadow:
                  e.iconshadow !== b ? e.iconshadow : d(l, h + "iconshadow"),
          ...
          d(l, h + "rel") === "popup" &&
            k.attr("href") &&
            (l.setAttribute("aria-haspopup", !0),
            l.setAttribute("aria-owns", k.attr("href"))),
            (w = a.data(
              l.tagName === "INPUT" || l.tagName === "BUTTON"
                ? l.parentNode
                : l,
              "buttonElements"
            )),
            w
              ? ((l = w.outer),
                ...
                (r = w.hover),
                (s = w.state))
              : ((t = c.createElement(m.wrapperEls)),
                (u = c.createElement(m.wrapperEls))),
            (v = m.icon ? c.createElement("span") : null),
            g && !w && g(),
            m.theme || (m.theme = a.mobile.getInheritedTheme(k, "c")),
            (p = "ui-btn "),
            (p += r ? "ui-btn-hover-" + m.theme : ""),
            (p += s ? " ui-btn-" + s + "-" + m.theme : ""),
            (p += m.shadow ? " ui-shadow" : ""),
            (p += m.corners ? " ui-btn-corner-all" : ""),
            m.mini !== b && (p += m.mini === !0 ? " ui-mini" : " ui-fullsize"),
            m.inline !== b &&
              (p += m.inline === !0 ? " ui-btn-inline" : " ui-btn-block"),
            m.icon &&
              ((m.icon = "ui-icon-" + m.icon),
              (m.iconpos = m.iconpos || "left"),
              (q = "ui-icon " + m.icon),
              m.iconshadow && (q += " ui-icon-shadow")),
            m.iconpos &&
              ((p += " ui-btn-icon-" + m.iconpos),
              m.iconpos === "notext" &&
                !k.attr("title") &&
            ...
            m.iconpos &&
              ...
              !k.attr("title") &&
              k.attr("title", k.getEncodedText()),
            w && k.removeClass(w.bcls || ""),
            k.removeClass("ui-link").addClass(p),
            (t.className = n),
            (u.className = o),
            w || t.appendChild(u);
          if (v) {
          ...
          w || l.appendChild(t),
            ...
            a.data(l, "buttonElements", w),
            a.data(t, "buttonElements", w),
            a.data(u, "buttonElements", w),
            v && a.data(v, "buttonElements", w);
        }
        return this;
      }),
        (a.fn.buttonMarkup.defaults = {
      ...
      var g = function () {
        ...
        a.mobile.document.bind({
          "vmousedown vmousecancel vmouseup vmouseover vmouseout focus blur scrollstart":
            function (g) {
              var i,
                j = a(e(g.target)),
              ...
              if (j.length) {
                ...
                if (l === "vmousedown")
                  k
                    ...
                    : f(j, "ui-btn-up-" + i, "ui-btn-down-" + i, b, "down");
                else if (l === "vmousecancel" || l === "vmouseup")
                  f(j, "ui-btn-down-" + i, "ui-btn-up-" + i, b, "up");
                else if (l === "vmouseover" || l === "focus")
                  k
                    ? (h = setTimeout(function () {
      ...
      (a.cleanData = function (b) {
        ...
        (a.widget = function (b, c, d) {
          ...
          (b = b.split(".")[1]),
            ...
            (g.prototype = a.widget.extend(
              ...
              d,
              { constructor: g, namespace: i, widgetName: b, widgetFullName: e }
            )),
            f
        ...
        (a.widget.extend = function (c) {
          ...
          for (; f < g; f++)
            for (h in e[f])
              (i = e[f][h]),
                e[f].hasOwnProperty(h) &&
                  i !== b &&
                  (a.isPlainObject(i)
                    ? (c[h] = a.isPlainObject(c[h])
                        ? a.widget.extend({}, c[h], i)
                        : a.widget.extend({}, i))
                    : (c[h] = i));
          return c;
        }),
      ...
      a.widget("mobile.widget", {
        ...
        enhance: function (b, c) {
          ...
          (f = a.mobile.enhanceable(f)),
            c &&
              f.length &&
              ((d = a.mobile.closestPageData(f)),
              (e = (d && d.keepNativeSelector()) || ""),
              (f = f.not(e))),
            f[this.widgetName]();
        },
        raise: function (a) {
      ...
      (a.mobile.path = d =
        {
          ...
          convertUrlToDataUrl: function (a) {
            ...
            return d.isEmbeddedPage(c)
              ? c.hash.split(g)[0].replace(/^#/, "").replace(/\?.*$/, "")
              : d.isSameDomain(c, this.documentBase)
              ? c.hrefNoHash.replace(this.documentBase.domain, "").split(g)[0]
          ...
          squash: function (a, b) {
            ...
            (b = b || (d.isPath(a) ? d.getLocation() : d.getDocumentUrl())),
              (f = i ? d.stripHash(a) : a),
              (f = d.isPath(j.hash) ? d.stripHash(j.hash) : f),
              (h = f.indexOf(this.uiStateKey)),
              h > -1 && ((l = f.slice(h)), (f = f.slice(0, h))),
              (e = d.makeUrlAbsolute(f, b)),
              (g = this.parseUrl(e).search);
            if (i) {
              if (
                d.isPath(k) ||
                k.replace("#", "").indexOf(this.uiStateKey) === 0
              )
                k = "";
              l && k.indexOf(this.uiStateKey) === -1 && (k += l),
                k.indexOf("#") === -1 && k !== "" && (k = "#" + k),
                (e = d.parseUrl(e)),
        ...
        (f = a("head").find("base")),
        (d.documentBase = f.length
          ? d.parseUrl(d.makeUrlAbsolute(f.attr("href"), d.documentUrl.href))
          : d.documentUrl),
        ...
        a.extend(a.mobile.History.prototype, {
          ...
          add: function (a, b) {
            (b = b || {}),
              ...
              b.hash && b.hash.indexOf("#") === -1 && (b.hash = "#" + b.hash),
              (b.url = a),
              this.stack.push(b),
      ...
      (a.mobile.Navigator = function (b) {
        ...
        a.extend(a.mobile.Navigator.prototype, {
          ...
          hash: function (a, b) {
            ...
            if (d.pathname + d.search === c.pathname + c.search)
              ...
              f =
                g.pathname +
                g.search +
                (e.isPreservableHash(g.hash) ? g.hash.replace("#", "") : "");
            } else f = a;
            return f;
          },
          go: function (d, f, g) {
            ...
            (i = e.squash(d)),
              (j = this.hash(d, i)),
              g &&
                j !== e.stripHash(e.parseLocation().hash) &&
        ...
        _getVisibles: function (a, b) {
          ...
          return (
            b
              ...
              : ((c = a.filter(":visible")),
                c.length === 0 && (c = a.not(".ui-screen-hidden"))),
            c
          );
        },
      ...
      a.widget("mobile.collapsible", a.mobile.widget, {
        ...
        _create: function () {
          var c = this.element,
            ...
            i = "";
          f.is("legend") &&
            ((f = a("<div role='heading'>" + f.html() + "</div>").insertBefore(
              f
            )),
            f.next().remove()),
            h.length
              ? (d.theme ||
                  (d.theme =
                    h.jqmData("theme") || a.mobile.getInheritedTheme(h, "c")),
                d.contentTheme || (d.contentTheme = h.jqmData("content-theme")),
                (d.collapsedIcon =
                  c.jqmData("collapsed-icon") ||
                  h.jqmData("collapsed-icon") ||
                  d.collapsedIcon),
                (d.expandedIcon =
                  c.jqmData("expanded-icon") ||
                  h.jqmData("expanded-icon") ||
                  d.expandedIcon),
                (d.iconpos =
                  c.jqmData("iconpos") || h.jqmData("iconpos") || d.iconpos),
                h.jqmData("inset") !== b
                  ? (d.inset = h.jqmData("inset"))
                  : (d.inset = !0),
                (d.corners = !1),
                d.mini || (d.mini = h.jqmData("mini")))
              : d.theme || (d.theme = a.mobile.getInheritedTheme(c, "c")),
            !d.inset ||
              ((i += " ui-collapsible-inset"),
              !d.corners || (i += " ui-corner-all")),
            d.contentTheme &&
              ((i += " ui-collapsible-themed-content"),
              g.addClass("ui-body-" + d.contentTheme)),
            i !== "" && e.addClass(i),
            f
              .insertBefore(g)
                  ...
                  b.preventDefault(),
                    f
                      ...
                      .toggleClass(
                        ...
                        e || d.expandedIcon === d.collapsedIcon
                      )
                      .end()
                      .find("a")
                      .first()
                    ...
                    g
                      .toggleClass("ui-collapsible-content-collapsed", e)
                      .attr("aria-hidden", e),
            ...
            f
              ...
              .bind("click", function (a) {
                var b = f.is(".ui-collapsible-heading-collapsed")
                  ? "expand"
                  : "collapse";
    ...
    (function (a, b) {
      ...
      a.widget("mobile.loader", {
        ...
        fakeFixLoader: function () {
          ...
          this.element.css({
            top:
              (a.support.scrollTop && f.scrollTop() + f.height() / 2) ||
        ...
        show: function (b, g, h) {
          ...
          this.resetHtml(),
            a.type(b) === "object"
              ? ((l = a.extend({}, this.options, b)),
                (b = l.theme || a.mobile.loadingMessageTheme))
              : ((l = this.options),
                (b = b || a.mobile.loadingMessageTheme || l.theme)),
            (j = g || a.mobile.loadingMessage || l.text),
            e.addClass("ui-loading");
          if (a.mobile.loadingMessage !== !1 || l.html)
            a.mobile.loadingMessageTextVisible !== d
              ? (i = a.mobile.loadingMessageTextVisible)
              : (i = l.textVisible),
              this.element.attr(
                "class",
                c +
                  ...
                  b +
                  " ui-loader-" +
                  (i || g || b.text ? "verbose" : "default") +
                  (l.textonly || h ? " ui-loader-textonly" : "")
              ),
              l.html
                ? this.element.html(l.html)
                : this.element.find("h1").text(j),
              this.element.appendTo(a.mobile.pageContainer),
              this.checkLoaderPosition(),
              f.bind("scroll", a.proxy(this.checkLoaderPosition, this));
        },
        hide: function () {
          e.removeClass("ui-loading"),
            a.mobile.loadingMessage &&
      ...
      a.widget("mobile.page", a.mobile.widget, {
        ...
        removeContainerBackground: function () {
          a.mobile.pageContainer.removeClass(
            "ui-overlay-" + a.mobile.getInheritedTheme(this.element.parent())
          );
        },
        setContainerBackground: function (b) {
          this.options.theme &&
            a.mobile.pageContainer.addClass(
      ...
      a.widget("mobile.textinput", a.mobile.widget, {
        ...
        _create: function () {
          ...
          var b = this,
            ...
            i,
            j,
            k = d.clearSearchButtonText || d.clearBtnText,
            l = c.is("textarea, :jqmData(type='range')"),
            m = !!d.clearBtn && !l,
            n = c.is("input") && !c.is(":jqmData(type='range')");
          a("label[for='" + c.attr("id") + "']").addClass("ui-input-text"),
            (i = c.addClass("ui-input-text ui-body-" + e)),
            typeof c[0].autocorrect != "undefined" &&
              !a.support.touchOverflow &&
              (c[0].setAttribute("autocorrect", "off"),
              c[0].setAttribute("autocomplete", "off")),
            h
              ? (i = c
                  .wrap(
            ...
            m || h
              ? ((j = a(
                ...
                h || i.addClass("ui-input-has-clear"),
                o(),
                c.bind("paste cut keyup input focus change blur", o))
              : !n && !h && c.addClass("ui-corner-all ui-shadow-inset" + f + g),
            c
              .focus(function () {
                d.preventFocusZoom && a.mobile.zoom.disable(!0),
                  i.addClass(a.mobile.focusClass);
              })
              .blur(function () {
                i.removeClass(a.mobile.focusClass),
                  d.preventFocusZoom && a.mobile.zoom.enable(!0);
              });
          if (c.is("textarea")) {
            var p = 15,
              q = 100,
            ...
            (this._keyup = function () {
              ...
              this._on(a.mobile.document, { pagechange: "_keyup" }),
              a.trim(c.val()) && this._on(a.mobile.window, { load: "_keyup" });
          }
        ...
        disable: function () {
          var a,
            ...
            c =
              ...
              !this.element.is(":jqmData(type='range')"),
            d = this.element.attr("disabled", !0) && (c || b);
          return (
            d ? (a = this.element.parent()) : (a = this.element),
    ...
    (function (a, d) {
      function w(b) {
        !!j &&
          (!j.closest("." + a.mobile.activePageClass).length || b) &&
          j.removeClass(a.mobile.activeBtnClass),
          (j = null);
      }
      function x() {
      ...
      function B(b, c, d, e) {
        c &&
          c.data("mobile-page")._trigger("beforehide", null, { nextPage: b }),
          b
            .data("mobile-page")
            ._trigger("beforeshow", null, { prevPage: c || a("") }),
          a.mobile.hidePageLoadingMsg(),
          (d = a.mobile._maybeDegradeTransition(d));
        var f =
            a.mobile.transitionHandlers[d || "default"] ||
        ...
        return (
          g.done(function () {
            c && c.data("mobile-page")._trigger("hide", null, { nextPage: b }),
              b
                .data("mobile-page")
                ._trigger("show", null, { prevPage: c || a("") });
          }),
          g
        );
      }
      ...
      var e = a.mobile.window,
          ...
          isFirstPageUrl: function (b) {
            var c = h.parseUrl(h.makeUrlAbsolute(b, this.documentBase)),
              e =
                ...
                (this.documentBaseDiffers &&
                  c.hrefNoHash === this.documentBase.hrefNoHash),
        ...
        v = a.support.dynamicBaseTag
          ? {
              element: q.length
                ? q
                : a("<base>", { href: s.hrefNoHash }).prependTo(g),
              set: function (a) {
                (a = h.parseUrl(a).hrefNoHash),
                  v.element.attr("href", h.makeUrlAbsolute(a, s));
              },
              reset: function () {
          ...
          : d;
      (a.mobile.getDocumentUrl = h.getDocumentUrl),
        (a.mobile.getDocumentBase = h.getDocumentBase),
      ...
      (z = function () {
        ...
        if (b) {
          var c = e.scrollTop();
          b.lastScroll =
            c < a.mobile.minScrollBack ? a.mobile.defaultHomeScroll : c;
        }
      }),
        (A = function () {
          setTimeout(z, 100);
        ...
        (a.mobile.resetActivePageHeight = function (c) {
          ...
          (c = typeof c == "number" ? c : u()),
            d.css("min-height", c - e - f - g - h);
        }),
        ...
        (a.mobile.path = h),
        (a.mobile.base = v),
        (a.mobile.urlHistory = l),
        (a.mobile.dialogHashKey = p),
        ...
        (a.mobile._bindPageRemove = function () {
          ...
          !b.data("mobile-page").options.domCache &&
            ...
            b.bind("pagehide.remove", function (b) {
              var c = a(this),
        ...
        (a.mobile.loadPage = function (b, c) {
          ...
          f.data &&
            f.type === "get" &&
            ((j = h.addSearchParams(j, f.data)), (f.data = d)),
            f.data && f.type === "post" && (f.reloadPage = !0);
          var k = h.getFilePath(j),
            l = h.convertUrlToDataUrl(j);
          (f.pageContainer = f.pageContainer || a.mobile.pageContainer),
            (g = f.pageContainer.children(
              "[data-" + a.mobile.ns + "url='" + l + "']"
            )),
            g.length === 0 &&
              l &&
              !h.isPath(l) &&
          ...
          return (
            v && v.reset(),
            !a.mobile.allowCrossDomainPages && !h.isSameDomain(r, j)
              ? e.reject(j, c)
              : a.ajax({
                  url: k,
                  type: f.type,
                  ...
                  success: function (d, m, n) {
                    ...
                    g
                      ...
                      (o.textStatus = m),
                      (o.page = g),
                      f.pageContainer.trigger("pageload", o),
                      e.resolve(j, c, g, i);
                  },
        ...
        (a.mobile.changePage = function (b, e) {
          ...
          var f = a.extend({}, a.mobile.changePage.defaults, e),
            g;
          (f.pageContainer = f.pageContainer || a.mobile.pageContainer),
            (f.fromPage = f.fromPage || a.mobile.activePage),
            (g = typeof b == "string");
          var i = f.pageContainer,
            j = new a.Event("pagebeforechange"),
            k = { toPage: b, options: f };
          g
            ? (k.absUrl = h.makeUrlAbsolute(b, D()))
            : (k.absUrl = b.data("absUrl")),
            i.trigger(j, k);
              ...
              a.mobile
                ...
                .fail(function (a, b) {
                  (o = !1),
                    w(!0),
                    x(),
                    f.pageContainer.trigger("pagechangefailed", k);
                });
            return;
          }
          b[0] === a.mobile.firstPage[0] &&
            !f.dataUrl &&
            (f.dataUrl = r.hrefNoHash);
          var m = f.fromPage,
            q =
              (f.dataUrl && h.convertUrlToDataUrl(f.dataUrl)) ||
              b.jqmData("url"),
            s = q,
            t = h.getFilePath(q),
            u = l.getActive(),
          ...
          if (m && m[0] === b[0] && !f.allowSamePageTransition) {
            (o = !1),
              i.trigger("pagechange", k),
              f.fromHashChange && l.direct({ url: q });
            return;
          }
          C(b, f.role),
            f.fromHashChange && (y = e.direction === "back" ? -1 : 1);
          try {
            c.activeElement && c.activeElement.nodeName.toLowerCase() !== "body"
          ...
          A &&
            ...
            (u.url &&
              ...
              ((f.changeHash = !1), (F = !0)),
            (q = u.url || ""),
            !F && q.indexOf("#") > -1 ? (q += p) : (q += "#" + p),
            l.activeIndex === 0 && q === l.initialDst && (q += p));
          var G = u
            ? b.jqmData("title") ||
              b
            ...
            : z;
          !!G && z === c.title && (z = G),
            b.jqmData("title") || b.jqmData("title", z),
            (f.transition =
              f.transition ||
              (y && !v ? u.transition : d) ||
              (A
            ...
            !y && F && (l.getActive().pageUrl = s);
          if (q && !f.fromHashChange) {
            var H;
            !h.isPath(q) && q.indexOf("#") < 0 && (q = "#" + q),
              (H = {
              ...
              f.changeHash !== !1 && a.mobile.hashListeningEnabled
                ? a.mobile.navigate(q, H, !0)
                : b[0] !== a.mobile.firstPage[0] &&
                  a.mobile.navigate.history.add(q, H);
          }
          (c.title = z),
            (a.mobile.activePage = b),
            (f.reverse = f.reverse || y < 0),
            B(b, m, f.transition, f.reverse).done(function (c, d, e, g, h) {
              w(),
                f.duplicateCachedPage && f.duplicateCachedPage.remove(),
                h || a.mobile.focusPage(b),
                x(),
                i.trigger("pagechange", k);
            });
        }),
        ...
        (a.mobile._registerInternalEvents = function () {
          var c = function (b, c) {
            ...
            return !a.mobile.ajaxEnabled ||
              ...
              : ((e = b.attr("target")),
                (f = b.attr("action")),
                f || ((f = F(b)), f === s.hrefNoHash && (f = r.hrefNoSearch)),
                (f = h.makeUrlAbsolute(f, F(b))),
                (h.isExternal(f) && !h.isPermittedCrossDomainRequest(r, f)) || e
                  ? !1
                  : (c ||
                      ((d = b.attr("method")),
                      (j = b.serializeArray()),
                      i &&
                        ...
                        k &&
                          ...
                          k && j.push({ name: k, value: i.attr("value") }))),
                      (g = {
                        url: f,
                        options: {
          ...
          a.mobile.document.delegate("form", "submit", function (b) {
            ...
            a.mobile.document.bind("vclick", function (b) {
              ...
              if (a.data(f, "mobile-button")) {
                ...
                if (
                  !f ||
                  h.parseUrl(f.getAttribute("href") || "#").hash === "#"
                )
                  return;
                if (!a(f).jqmHijackable().length) return;
              }
              ~f.className.indexOf("ui-link-inherit")
                ? f.parentNode && (e = a.data(f.parentNode, "buttonElements"))
                : (e = a.data(f, "buttonElements")),
                e ? (f = e.outer) : (g = !0),
                (d = a(f)),
                g && (d = d.closest(".ui-btn")),
                d.length > 0 &&
                  !d.hasClass("ui-disabled") &&
                  (w(!0), (j = d), j.addClass(a.mobile.activeBtnClass));
            }),
            a.mobile.document.bind("click", function (c) {
              ...
              if (j.search("#") !== -1) {
                ...
                h.isPath(j)
                  ? (j = h.makeUrlAbsolute(j, i))
                  : (j = h.makeUrlAbsolute("#" + j, r.hrefNoHash));
              }
              var k =
                  f.is("[rel='external']") ||
                  f.is(":jqmData(ajax='false')") ||
                  f.is("[target]"),
                l =
                  k ||
                  (h.isExternal(j) && !h.isPermittedCrossDomainRequest(r, j));
              if (l) {
                g();
                return;
              }
            ...
            (a.mobile._handleHashChange = function (c, e) {
              ...
              f
                ? ((f = h.isPath(f) ? f : h.makeUrlAbsolute("#" + f, s)),
                  f === h.makeUrlAbsolute("#" + l.initialDst, s) &&
                    l.stack.length &&
                    l.stack[0].url !== l.initialDst.replace(p, "") &&
                    (f = a.mobile.firstPage),
                  a.mobile.changePage(f, i))
                : a.mobile.changePage(a.mobile.firstPage, i);
            }),
            e.bind("navigate", function (b, c) {
              var d =
                a.event.special.navigate.originalEventName.indexOf(
                  "hashchange"
                ) > -1
                  ? c.state.hash
                  : c.state.url;
              ...
              if (
                !d ||
                d === "#" ||
                d.indexOf("#" + a.mobile.path.uiStateKey) === 0
              )
                d = location.href;
      ...
      a.widget("mobile.dialog", a.mobile.widget, {
          ...
          c.addClass("ui-dialog ui-overlay-" + this.options.overlayTheme),
            ...
            c.bind("vclick submit", function (b) {
              var c = a(b.target).closest(b.type === "vclick" ? "a" : "form"),
                d;
              c.length &&
                !c.jqmData("transition") &&
                ((d = a.mobile.urlHistory.getActive() || {}),
                c
                  .attr(
                    "data-" + a.mobile.ns + "transition",
                    d.transition || a.mobile.defaultDialogTransition
                  )
                  .attr("data-" + a.mobile.ns + "direction", "reverse"));
            }),
            this._on(c, { pagebeforeshow: "_handlePageBeforeShow" }),
          ...
          this._headerCloseButton &&
            ...
            b !== "none" &&
              ...
              this.element
                ...
                .first()
                .prepend(d),
              this._createComplete && a.fn.buttonMarkup && d.buttonMarkup(),
        ...
        _setOption: function (b, c) {
          b === "closeBtn" &&
            (this._setCloseBtn(c),
            this._super(b, c),
            this.element.attr("data-" + (a.mobile.ns || "") + "close-btn", c));
        },
        close: function () {
          var b,
            c,
            ...
            a.mobile.hashListeningEnabled && d.activeIndex > 0
              ...
              : ((b = Math.max(0, d.activeIndex - 1)),
                ...
                a.mobile.path.isPath(c) ||
                  (c = a.mobile.path.makeUrlAbsolute("#" + c)),
        ...
        a.mobile.document.delegate(
          a.mobile.dialog.prototype.options.initSelector,
          "pagecreate",
          function () {
          ...
          a(
            ...
            .each(function () {
              ...
              if (g === "header" || g === "footer") {
                var n =
                  h || (g === "header" ? d.headerTheme : d.footerTheme) || f;
                b
                  .addClass("ui-bar-" + n)
                  .attr("role", g === "header" ? "banner" : "contentinfo"),
                  g === "header" &&
                    ((j = b.children("a, button")),
                    (k = j.hasClass("ui-btn-left")),
                    (l = j.hasClass("ui-btn-right")),
                    (k =
                      k ||
                      j.eq(0).not(".ui-btn-right").addClass("ui-btn-left")
                        .length),
                    (l = l || j.eq(1).addClass("ui-btn-right").length)),
                  d.addBackBtn &&
                    g === "header" &&
                    a(".ui-page").length > 1 &&
                    c.jqmData("url") !==
      ...
      a.widget("mobile.fixedtoolbar", a.mobile.widget, {
        ...
        _create: function () {
          ...
          d.addClass("ui-" + e + "-fixed"),
            c.fullscreen
              ? (d.addClass("ui-" + e + "-fullscreen"),
                f.addClass("ui-page-" + e + "-fullscreen"))
        ...
        _addTransitionClass: function () {
          ...
          a &&
            a !== "none" &&
            (a === "slide" &&
              (a = this.element.is(".ui-header") ? "slidedown" : "slideup"),
        ...
        _handlePageBeforeHide: function (b, c) {
          ...
          d.disablePageZoom && a.mobile.zoom.enable(!0),
            d.updatePagePadding &&
              this._off(a.mobile.window, "throttledresize");
            ...
            var e = a(".ui-footer-fixed:jqmData(id)", this._thisPage),
              ...
              g =
                (e.length &&
                  c.nextPage &&
                  a(
                    ".ui-footer-fixed:jqmData(id='" + e.jqmData("id") + "')",
                    c.nextPage
                  )) ||
                a(),
              h =
                (f.length &&
                  c.nextPage &&
                  a(
                    ".ui-header-fixed:jqmData(id='" + f.jqmData("id") + "')",
                    c.nextPage
                  )) ||
                a();
        ...
        updatePagePadding: function (b) {
          ...
          (b = b || this._thisPage || c.closest(".ui-page")),
            a(b).css("padding-" + (d ? "top" : "bottom"), c.outerHeight() + e);
        },
        _useTransition: function (b) {
          ...
          return (
            ...
            ((this.options.transition &&
              ...
              ((i === "header" && !this.options.fullscreen && e > f) ||
                (i === "footer" &&
        ...
        _bindToggleHandlers: function () {
          ...
          e.closest(".ui-page")
            .bind("vclick", function (c) {
              d.tapToggle &&
                !a(c.target).closest(d.tapToggleBlacklist).length &&
                b.toggle();
            })
            .bind("focusin focusout", function (e) {
              screen.width < 1025 &&
                a(e.target).is(d.hideDuringFocus) &&
                !a(e.target).closest(".ui-header-fixed, .ui-footer-fixed")
                  .length &&
                (e.type === "focusout" && !b._visible
                  ? (c = setTimeout(function () {
                      b.show();
                    }, 0))
                  : e.type === "focusin" &&
                    b._visible &&
                    (clearTimeout(c), b.hide()));
            });
        },
        _destroy: function () {
          var a = this.element,
      ...
      a.widget("mobile.fixedtoolbar", a.mobile.fixedtoolbar, {
        ...
        _viewportOffset: function () {
          ...
          return (
            c ||
              (d =
                Math.round(d - a.mobile.window.height() + b.outerHeight()) -
                60),
            d
          );
        },
      ...
      a.widget("mobile.listview", a.mobile.widget, {
        ...
        refresh: function (b) {
          ...
          var d = this.options,
            ...
            B,
            C;
          l && m && e.find(".ui-li-dec").remove(),
            l &&
              (n || n === 0
                ? m
                  ? (v = parseInt(n, 10))
                  : ((w = parseInt(n, 10) - 1),
                    e.css("counter-reset", "listnumbering " + w))
                : m && (v = 1)),
            d.theme ||
              (d.theme = a.mobile.getInheritedTheme(this.element, "c"));
          for (var D = 0, E = k.length; D < E; D++) {
            (p = k.eq(D)), (q = "ui-li");
            if (b || !p.hasClass("ui-li")) {
              (r = p.jqmData("theme") || d.theme),
                (s = this._getChildrenByTagName(p[0], "a", "A"));
              ...
              s.length && !F
                ? ((z = p.jqmData("icon")),
                  ...
                  z !== !1 && s.length === 1 && p.addClass("ui-li-has-arrow"),
                  s.first().removeClass("ui-link").addClass("ui-link-inherit"),
                  s.length > 1 &&
                    ((q += " ui-li-has-alt"),
                    (t = s.last()),
                    (u = h || t.jqmData("theme") || d.splitTheme),
                    (C = t.jqmData("icon")),
                    t
                      .appendTo(p)
                      .attr("title", a.trim(t.getEncodedText()))
                ...
                : F
                ? ((q += " ui-li-divider ui-bar-" + (p.jqmData("theme") || g)),
                  p.attr("role", "heading"),
                  l &&
                    (n || n === 0
                      ? m
                        ? (v = parseInt(n, 10))
                        : ((x = parseInt(n, 10) - 1),
                          p.css("counter-reset", "listnumbering " + x))
                      : m && (v = 1)))
                : (q += " ui-li-static ui-btn-up-" + r);
            }
            l &&
              m &&
              q.indexOf("ui-li-divider") < 0 &&
              ((y =
                q.indexOf("ui-li-static") > 0 ? p : p.find(".ui-link-inherit")),
              y
                .addClass("ui-li-jsnumbering")
                .prepend("<span class='ui-li-dec'>" + v++ + ". </span>")),
              o[q] || (o[q] = []),
              o[q].push(p[0]);
          }
          for (q in o)
            a(o[q]).addClass(q).children(".ui-btn-inner").addClass(q);
          e
            ...
            .addClass(
              "ui-btn-up-" +
                (e.jqmData("counttheme") || this.options.countTheme) +
                " ui-btn-corner-all"
            ),
            this._addThumbClasses(k),
            this._addThumbClasses(e.find(".ui-link-inherit")),
            this._addFirstLastClasses(k, this._getVisibles(k, b), b),
        ...
        _createSubPages: function () {
          var b = this.element,
            ...
            l;
          typeof d[f] == "undefined" && (d[f] = -1),
            (g = g || ++d[f]),
            a(b.find("li>ul, li>ol").toArray().reverse())
              .each(function (c) {
                var d = this,
                  f = a(this),
                  j = f.attr("id") || g + "-" + c,
                  ...
                  p = n.length
                    ? n
                    : a(
                        "<span>" + a.trim(m.contents()[0].nodeValue) + "</span>"
                      ),
          ...
          if (
            ...
            c.data("mobile-page").options.domCache === !1
          ) {
            var m = function (b, d) {
              var f = d.nextPage,
                g,
              ...
              d.nextPage &&
                ((g = f.jqmData("url")),
                g.indexOf(e + "&" + a.mobile.subPageUrlKey) !== 0 &&
                  (j.childPages().remove(),
                  c.trigger(h),
                  h.isDefaultPrevented() || c.removeWithDependents()));
            };
    ...
    (function (a, b) {
      (a.mobile.listview.prototype.options.autodividers = !1),
        (a.mobile.listview.prototype.options.autodividersSelector = function (
          b
        ) {
        ...
        a.mobile.document.delegate("ul,ol", "listviewcreate", function () {
          ...
          var e = function () {
            ...
            f = function () {
              b.unbind("listviewafterrefresh", f),
                e(),
                d.refresh(),
                b.bind("listviewafterrefresh", f);
            };
          f();
        });
    })(a),
    (function (a, b) {
      ...
      (a.mobile.listview.prototype.options.filterCallback = c),
        a.mobile.document.delegate("ul, ol", "listviewcreate", function () {
          var b = a(this),
            d = b.data("mobile-listview");
          ...
          var e = a("<form>", {
            ...
            f = function (e) {
              var f = a(this),
                ...
                l = "",
                m,
                n = d.options.filterCallback !== c;
              if (j && j === g) return;
              d._trigger("beforefilter", "beforefilter", { input: this }),
                f.jqmData("lastval", g),
                n || g.length < j.length || g.indexOf(j) !== 0
                  ? (h = b.children())
                  : ((h = b.children(":not(.ui-screen-hidden)")),
                    !h.length &&
                      d.options.filterReveal &&
                      (h = b.children(".ui-screen-hidden")));
              if (g) {
                for (var o = h.length - 1; o >= 0; o--)
                  (m = a(h[o])),
                    (l = m.jqmData("filtertext") || m.text()),
                    m.is("li:jqmData(role=list-divider)")
                      ? (m.toggleClass("ui-filter-hidequeue", !k), (k = !1))
                      : d.options.filterCallback(l, g, m)
                      ? m.toggleClass("ui-filter-hidequeue", !0)
                      : (k = !0);
                h
                  .filter(":not(.ui-filter-hidequeue)")
                  .toggleClass("ui-screen-hidden", !1),
                  h
      ...
      a.widget("mobile.panel", a.mobile.widget, {
        ...
        _create: function () {
              ...
              return (
                a.length === 0 &&
                  (a = c
                    .children()
                    .wrapAll(
                      '<div class="' + b.options.classes.panelInner + '" />'
                    )
                    .parent()),
                a
              );
          ...
          a.extend(this, {
            ...
            b._fixedToolbar.addClass(
              this.options.classes.contentFixedToolbarClosed
            ),
        ...
        _positionPanel: function () {
          ...
          d || !b.options.positionFixed
            ? (d && (b._unfixPanel(), a.mobile.resetActivePageHeight(c)),
              b._scrollIntoView(c))
            : b._fixPanel();
        },
        ...
        _bindSwipeEvents: function () {
          ...
          !a.options.swipeClose ||
            (a.options.position === "left"
              ? b.on("swipeleft.panel", function (b) {
                  a.close();
                })
              ...
              e = function () {
                c._page.off("panelclose"),
                  ...
                  !b && a.support.cssTransform3d && !!d.animate
                    ...
                    : setTimeout(f, 0),
                  c.options.theme &&
                    c.options.display !== "overlay" &&
                    c._page
                      .removeClass(c._pageTheme)
                      .addClass("ui-body-" + c.options.theme),
                  c.element
                    .removeClass(d.classes.panelClosed)
                    .addClass(d.classes.panelOpen),
                  (c._contentWrapOpenClasses = c._getPosDisplayClasses(
                    d.classes.contentWrap
                  )),
                  c._wrapper
                    .removeClass(d.classes.contentWrapClosed)
                    .addClass(
                      c._contentWrapOpenClasses +
                        " " +
                        d.classes.contentWrapOpen
                    ),
                  (c._fixedToolbarOpenClasses = c._getPosDisplayClasses(
                    d.classes.contentFixedToolbar
                  )),
                  c._fixedToolbar
            ...
            var c = this.options,
              ...
              e = function () {
                !b && a.support.cssTransform3d && !!c.animate
                  ...
                  d._fixedToolbar.removeClass(
                    c.classes.contentFixedToolbarOpen
                  ),
                  d._modal && d._modal.removeClass(d._modalOpenClasses);
              },
              f = function () {
                d.options.theme &&
                  d.options.display !== "overlay" &&
                  d._page
                    .removeClass("ui-body-" + d.options.theme)
                    .addClass(d._pageTheme),
                  d.element.add(d._wrapper).off(d._transitionEndEvents, f),
                  d.element.addClass(c.classes.panelClosed),
                  d._wrapper
                    .removeClass(d._contentWrapOpenClasses)
                    .addClass(c.classes.contentWrapClosed),
                  d._fixedToolbar
                    .removeClass(d._fixedToolbarOpenClasses)
        ...
        _destroy: function () {
          ...
          d
            ...
            this.element
              ...
              .removeClass(
                [b.panelUnfixed, b.panelClosed, b.panelOpen].join(" ")
              );
        },
      }),
        a(c).bind("pagecreate create", function (b) {
    ...
    (function (a, d) {
      ...
      a.widget("mobile.popup", a.mobile.widget, {
        ...
        _handleDocumentFocusIn: function (b) {
          ...
          if (d !== f.container[0]) {
            e = a(b.target);
            if (0 === e.parents().filter(f.container[0]).length)
              return (
                a(c.activeElement).one("focus", function (a) {
                  e.blur();
                }),
            ...
            f.focusElement &&
              ...
              (f.container.blur(), f.focusElement.focus());
          this._ignoreResizeEvents();
        },
        _create: function () {
          var b = {
          ...
          (this.options.history =
            ...
            (this.options.container =
              this.options.container || a.mobile.pageContainer),
            c.append(b.screen),
            b.container.insertAfter(b.screen),
            b.placeholder.insertAfter(this.element),
            e &&
              (b.screen.attr("id", e + "-screen"),
              b.container.attr("id", e + "-popup"),
              b.placeholder.html("<!-- placeholder for " + e + " -->")),
        ...
        _applyTheme: function (a, b, c) {
          ...
          b !== f &&
            (a.removeClass("ui-" + c + "-" + f),
            b !== null && b !== "none" && a.addClass("ui-" + c + "-" + h));
        },
        ...
        _setOption: function (b, c) {
          var e,
            f = "_set" + b.charAt(0).toUpperCase() + b.slice(1);
          this[f] !== d && this[f](c),
            (e = [
              "initSelector",
              "closeLinkSelector",
            ...
            a.mobile.widget.prototype._setOption.apply(this, arguments),
            a.inArray(b, e) === -1 &&
              this.element.attr(
                "data-" +
                  (a.mobile.ns || "") +
                  b.replace(/([A-Z])/, "-$1").toLowerCase(),
                c
              );
        },
        _placementCoords: function (a) {
          var b = f(),
            ...
            g,
            h;
          this._ui.container.css("max-width", d.cx),
            (g = {
              cx: this._ui.container.outerWidth(!0),
              cy: this._ui.container.outerHeight(!0),
            }),
            (h = { x: e(d.cx, g.cx, d.x, a.x), y: e(d.cy, g.cy, d.y, a.y) }),
            (h.y = Math.max(0, h.y));
          ...
          return (
            (h.y -= Math.min(h.y, Math.max(0, h.y + g.cy - k))),
            { left: h.x, top: h.y }
          );
        },
        _createPrereqs: function (b, c, d) {
          var e = this,
            f;
          (f = { screen: a.Deferred(), container: a.Deferred() }),
        ...
        _desiredCoords: function (b) {
          ...
          c &&
            ((d = c.offset()),
            (g = d.left + c.outerWidth() / 2),
            (h = d.top + c.outerHeight() / 2));
        ...
        _reposition: function (a) {
          (a = { x: a.x, y: a.y, positionTo: a.positionTo }),
            this._trigger("beforeposition", a),
        ...
        _open: function (c) {
          var d = a.extend({}, this.options, c),
            e = (function () {
              ...
              return f !== null && g === "4.0" && e && e > 534.13 && !h
                ? !0
                : !1;
            })();
          this._createPrereqs(
            a.noop,
            a.noop,
            a.proxy(this, "_openPrereqsComplete")
          ),
            ...
            this.options.theme ||
              this._setTheme(
                this._page.jqmData("theme") ||
                  a.mobile.getInheritedTheme(this._page, "c")
              ),
        ...
        _destroy: function () {
          a.mobile.popup.active === this
            ? (this.element.one("popupafterclose", a.proxy(this, "_unenhance")),
              this.close())
            : this._unenhance();
        },
        _closePopup: function (c, d) {
          ...
          b.scrollTo(0, this._scrollTop),
            c &&
              c.type === "pagebeforechange" &&
              d &&
              (typeof d.toPage == "string"
                ? (e = d.toPage)
                : (e = d.toPage.jqmData("url")),
        ...
        open: function (c) {
          ...
          (k = a.mobile.urlHistory),
            (g = a.mobile.dialogHashKey),
            (h = a.mobile.activePage),
            (i = h.is(".ui-dialog")),
            (this._myUrl = f = k.getActive().url),
            (j = f.indexOf(g) > -1 && !i && k.activeIndex > 0);
          if (j) {
          ...
          f.indexOf(g) === -1 && !i
            ? (f += f.indexOf("#") > -1 ? g : "#" + g)
            : (f = a.mobile.path.parseLocation().hash + g),
            k.activeIndex === 0 && f === k.initialDst && (f += g),
            a(b).one("beforenavigate", function (a) {
              a.preventDefault(), d._open(c), d._bindContainerClose();
            }),
            (this.urlAltered = !0),
            a.mobile.navigate(f, { role: "dialog" });
        },
        close: function () {
      ...
      a.widget("mobile.table", a.mobile.widget, {
        ...
        _create: function () {
          ...
          this.element.addClass(this.options.classes.table),
            (b.headers = this.element.find("tr:eq(0)").children()),
            (b.allHeaders = b.headers.add(c.children())),
            c.each(function () {
              var d = 0;
              a(this)
                .children()
                .each(function (e) {
                  ...
                  a(this).jqmData(
                    "cells",
                    b.element.find("tr").not(c.eq(0)).not(this).children(g)
                  ),
                    d++;
                });
            });
        ...
        refresh: function () {
          ...
          a.mobile.checkboxradio &&
            ...
            this._addFirstLastClasses(
              b,
              this.options.excludeInvisible ? this._getVisibles(b, c) : b,
              c
            ),
      ...
      a.widget("mobile.checkboxradio", a.mobile.widget, {
        ...
        _create: function () {
          ...
          a.extend(this, {
            ...
            e.theme ||
              (e.theme = a.mobile.getInheritedTheme(this.element, "c")),
            h.buttonMarkup({
              theme: e.theme,
              icon: l,
              shadow: !1,
          ...
          (p.className = "ui-" + i),
            ...
            d.bind({
              ...
              vclick: function () {
                ...
                c.is(":checked")
                  ? (c.prop("checked", !0),
                    b._getInputSet().not(c).prop("checked", !1))
                  : c.prop("checked", !1),
                  b._updateAll();
              },
              focus: function () {
            ...
            this._handleFormReset && this._handleFormReset(),
            this.refresh();
        },
        _cacheVals: function () {
        ...
        _updateAll: function () {
          ...
          this._getInputSet()
            .each(function () {
              var c = a(this);
              (this.checked || b.inputtype === "checkbox") &&
                c.trigger("change");
            })
        ...
        refresh: function () {
          var b = this.element[0],
            ...
            d =
              this.checkedClass +
              (this.element.parents(".ui-controlgroup-horizontal").length
                ? c
                : ""),
            e = this.label;
          b.checked
            ...
            : e
                ...
                .buttonMarkup({ icon: this.uncheckedicon }),
    ...
    (function (a, b) {
      (a.mobile.table.prototype.options.mode = "columntoggle"),
        ...
        (a.mobile.table.prototype.options.classes = a.extend(
        ...
        a.mobile.document.delegate(
          ...
          function () {
            ...
            c.headers.not("td").each(function () {
              ...
              b &&
                (c.addClass(d.classes.priorityPrefix + b),
                a(
                  ...
                  .children(0)
                  .jqmData("cells", c)
                  .checkboxradio({ theme: d.columnPopupTheme }));
            }),
              i.appendTo(h),
              i.on("change", "input", function (b) {
                this.checked
                  ? a(this)
                      .jqmData("cells")
                      .removeClass("ui-table-cell-hidden")
                      .addClass("ui-table-cell-visible")
                  : a(this)
                      .jqmData("cells")
                      .removeClass("ui-table-cell-visible")
                      .addClass("ui-table-cell-hidden");
              }),
              g.insertBefore(b).buttonMarkup({ theme: d.columnBtnTheme }),
              h.insertBefore(b).popup(),
              (c.refresh = function () {
                i.find("input").each(function () {
                  (this.checked =
                    a(this).jqmData("cells").eq(0).css("display") ===
                    "table-cell"),
                    a(this).checkboxradio("refresh");
                });
              }),
              a.mobile.window.on("throttledresize", c.refresh),
              c.refresh();
          }
        );
    })(a),
          ...
          function () {
            ...
            e.each(function (b) {
              var c = a(this).jqmData("cells"),
                ...
                f =
                  c.not(this).filter("thead th").length &&
              ...
              if (g !== "")
                if (f) {
                  var h = parseInt(a(this).attr("colspan"), 10),
                    i = "";
                  h && (i = "td:nth-child(" + h + "n + " + e + ")"),
                    c
                      .filter(i)
                      .prepend(
                        "<b class='" +
                          d.classes.cellLabels +
                          f +
                          "'>" +
                          g +
                          "</b>"
                  ...
                  c.prepend(
                    "<b class='" + d.classes.cellLabels + "'>" + g + "</b>"
                  );
            });
          }
        );
